...
export default function Home() {
    ...
    return(
        <div id="home">
            <div className="container">
                ...
                <div className="stat-box">
                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                        <span style={{ fontSize: '14px', color: '#646669' }}>{t("time")}:</span>
                        <span className="stat-text" style={{ fontSize: '24px', fontWeight: 'bold', color: '#e2b714' }}>
                            {isInfinite ? `∞ (${t("infinite")})` : `${timeLeft}s`}
                        </span>
                    </div>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '20px', marginLeft: "auto" }}>
                        ...
                        >
                            ...
                            >
                                {t("langText")}: {textLang === "vi" ? "Tiếng Việt" : "English"}
                            </button>
                        ...
                        <div style={{ textAlign: 'center' }}>
                            <p style={{ fontSize: '13px', color: '#646669', margin: 0 }}>{t("speed")}</p>
                            <p className="stat-text" style={{ fontSize: '26px', fontWeight: 'bold', color: '#e2b714', margin: 0 }}>{wpm}</p>
                        </div>
                        <div style={{ textAlign: 'center' }}>
                            <p style={{ fontSize: '13px', color: '#646669', margin: 0 }}>{t("accuracy")}</p>
                    ...
                    >
                        ...
                        {isDropdownOpen && (
                            <div
                                ...
                                style={{ position: 'absolute', top: '100%', right: 0, backgroundColor: '#2c2e31', border: '1px solid #444649', borderRadius: '8px', padding: '6px', display: 'flex', flexDirection: 'column', gap: '4px', width: 'max-content', boxShadow: '0px 10px 30px rgba(0,0,0,0.5)', marginTop: '4px', zIndex: '999' }}
                            >
                                <button onMouseEnter={activateHoverStyle} onMouseLeave={deactivateHoverStyle} onClick={() => { setIsTextModalOpen(true); setIsDropdownOpen(false); }} style={{ backgroundColor: 'transparent', color: '#d1d0c5', border: 'none', padding: '10px 16px', textAlign: 'left', cursor: 'pointer', borderRadius: '4px', fontSize: '15px', fontFamily: 'monospace', whiteSpace: 'nowrap' }}>{t("home:optText")}</button>
                                <button onMouseEnter={activateHoverStyle} onMouseLeave={deactivateHoverStyle} onClick={() => { setIsLayoutModalOpen(true); setIsDropdownOpen(false); }} style={{ backgroundColor: 'transparent', color: '#d1d0c5', border: 'none', padding: '10px 16px', textAlign: 'left', cursor: 'pointer', borderRadius: '4px', fontSize: '15px', fontFamily: 'monospace', whiteSpace: 'nowrap', transition: "background 0.2s" }}>{t("home:optLayout")}</button>
                                <button onMouseEnter={activateHoverStyle} onMouseLeave={deactivateHoverStyle} onClick={() => { openTimeModal(); setIsDropdownOpen(false); }} style={{ backgroundColor: 'transparent', color: '#d1d0c5', border: 'none', padding: '10px 16px', textAlign: 'left', cursor: 'pointer', borderRadius: '4px', fontSize: '15px', fontFamily: 'monospace', whiteSpace: 'nowrap', transition: "background 0.2s" }}>{t("home:optTime")}</button>
                            </div>
                        )}
                    </div>
                </div>
                    ...
                    <div className="dashboard-container">
                        ...
                        <div className="left-card">
                            <div style={{ display: "flex", justifyContent: "space-between", width: "100%", marginBottom: "16px" }}>
                                <div style={{ flex: 1 }}>
                                    <p style={{ margin: 0, fontSize: "14px", color: "#646669", fontWeight: "bold" }}>{t("speed")}</p>
                                ...
                                <div style={{ flex: 1 }}>
                                    <p style={{ margin: 0, fontSize: "14px", color: "#646669", fontWeight: "bold" }}>{t("accuracy")}</p>
                            ...
                            <p style={{ margin: "0 0 24px 0", color: "#646669", fontSize: "13px" }}>{t("rankDesc")}</p>
                            ...
                            <div style={{ display: "flex", gap: "8px", width: "100%" }}>
                                <button style={{ flex: 1, backgroundColor: "#1877f2", color: "#fff", border: "none", borderRadius: "20px", padding: "10px", fontSize: "13px", fontWeight: "bold", cursor: "pointer" }}>{t("share")}</button>
                                <button style={{ flex: 1, backgroundColor: "#444649", color: "#d1d0c5", border: "none", borderRadius: "20px", padding: "10px", fontSize: "13px", fontWeight: "bold", cursor: "pointer" }}>{t("copyLink")}</button>
                            </div>
                        </div>
                        ...
                        <div className="right-layout">
                            <div className="speed-card">
                                <h4 style={{ margin: "0 0 16px 0", fontSize: "13px", color: "#646669", letterSpacing: "0.5px" }}>{t("speedAnalysis")}</h4>
                                <div style={{ display: "flex", justifyContent: "space-between", textAlign: "center" }}>
                                    <div style={{ flex: 1 }}>
                                        <p style={{ margin: 0, fontSize: "28px", fontWeight: "bold", color: "#fff" }}>{grossWpm}</p>
                                        <p style={{ margin: "4px 0 0 0", fontSize: "12px", color: "#646669" }}>{t("grossWpm")}</p>
                                    </div>
                                    <div style={{ flex: 1, borderLeft: "1px solid #444649", borderRight: "1px solid #444649" }}>
                                        ...
                                        <p style={{ margin: "4px 0 0 0", fontSize: "12px", color: "#646669" }}>{t("netWpm")}</p>
                                    </div>
                                    <div style={{ flex: 1 }}>
                                        <p style={{ margin: 0, fontSize: "28px", fontWeight: "bold", color: "#ca4754" }}>{backspaceCount}</p>
                                        <p style={{ margin: "4px 0 0 0", fontSize: "12px", color: "#646669" }}>{t("backspace")}</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="wrong-words-card">
                                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "16px" }}>
                                    <h4 style={{ margin: 0, fontSize: "13px", color: "#646669", letterSpacing: "0.5px" }}>{t("wrongWordsTitle")}</h4>
                                    {wrongWords.length > 0 && (
            ...
            {isTextModalOpen && (
                <div onClick={() => setIsTextModalOpen(false)} className="modal-setting">
                    <div
                        onClick={(e) => e.stopPropagation()}
                    ...
                    >
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                            <h3 style={{ margin: 0, fontSize: '18px', color: '#e2b714' }}>{t("modalTextTitle")}</h3>
                        ...
                        <p style={{ margin: 0, fontSize: '13px', color: '#646669', lineHeight: '1.4' }}>{t("modalTextDesc")}</p>
                        <textarea
                            rows="5"
                        ...
                        <div style={{ display: 'flex', justifyContent: 'flex-end', gap: '12px' }}>
                            <button onClick={() => setIsTextModalOpen(false)} style={{ backgroundColor: '#323437', color: '#646669', border: '1px solid #444649', padding: '10px 16px', borderRadius: '8px', cursor: 'pointer', fontWeight: 'bold', fontSize: '14px' }}>{t("cancel")}</button>
                            <button onClick={handleSaveCustomText} style={{ backgroundColor: '#e2b714', color: '#2c2e31', border: 'none', padding: '10px 16px', borderRadius: '8px', cursor: 'pointer', fontWeight: 'bold', fontSize: '14px' }}>{t("save")}</button>
                        </div>
                    </div>
                </div>
            )}
            ...
            {isLayoutModalOpen && (
                <div onClick={() => setIsLayoutModalOpen(false)} className="modal-setting">
                    <div
                        onClick={(e) => e.stopPropagation()}
                    ...
                    >
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                            <h3 style={{ margin: 0, fontSize: '18px', color: '#e2b714' }}>{t("modalLayoutTitle")}</h3>
                        ...
                        <p style={{ margin: 0, fontSize: '13px', color: '#646669', lineHeight: '1.4' }}>{t("modalLayoutDesc")}</p>
                        <input
                            type="number"
                            min="3"
                            max="15"
                        ...
                        />
                        <div style={{ display: 'flex', justifyContent: 'flex-end', gap: '12px' }}>
                            <button onClick={() => setIsLayoutModalOpen(false)} style={{ backgroundColor: '#323437', color: '#646669', border: '1px solid #444649', padding: '10px 16px', borderRadius: '8px', cursor: 'pointer', fontWeight: 'bold', fontSize: '14px' }}>{t("cancel")}</button>
                            <button onClick={handleSaveLayout} style={{ backgroundColor: '#e2b714', color: '#2c2e31', border: 'none', padding: '10px 16px', borderRadius: '8px', cursor: 'pointer', fontWeight: 'bold', fontSize: '14px' }}>{t("apply")}</button>
                        </div>
                    </div>
                </div>
            )}
            ...
            {isTimeModalOpen && (
                <div onClick={() => setIsTimeModalOpen(false)} className="modal-setting">
                    <div
                        onClick={(e) => e.stopPropagation()}
                    ...
                    >
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                            <h3 style={{ margin: 0, fontSize: '18px', color: '#e2b714' }}>{t("modalTimeTitle")}</h3>
                        ...
                        {!tempIsInfinite && (
                            <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                                <span style={{ fontSize: '13px', color: '#646669' }}>{t("modalTimeDesc")}</span>
                                <input
                                    type="number"
                                    min="5"
                                    max="3600"
                        ...
                        <div style={{ display: 'flex', justifyContent: 'flex-end', gap: '12px', marginTop: '4px' }}>
                            <button onClick={() => setIsTimeModalOpen(false)} style={{ backgroundColor: '#323437', color: '#646669', border: '1px solid #444649', padding: '10px 16px', borderRadius: '8px', cursor: 'pointer', fontWeight: 'bold', fontSize: '14px' }}>{t("cancel")}</button>
                            <button onClick={handleSaveTimeConfig} style={{ backgroundColor: '#e2b714', color: '#2c2e31', border: 'none', padding: '10px 16px', borderRadius: '8px', cursor: 'pointer', fontWeight: 'bold', fontSize: '14px' }}>{t("apply")}</button>
                        </div>
                    </div>
                </div>
            )}
